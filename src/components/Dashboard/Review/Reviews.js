...
const Reviews = () => {
  ...
  const handleSubmit = () => {
    ...
    fetch("https://time-sheriff-server.vercel.app/reviews", {
      method: "POST",
      headers: {
  ...
  return (
    <>
      ...
      <div className=" p-4 pr-5 mt-5 mb-5 w-75 mx-auto">
        ...
        <h5 className="text-brand mt-4 text-center writeReviewInput">
          Write your Comment..
        </h5>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="exampleInputPassword1" className="writeReviewInput">
              <FontAwesomeIcon
                icon={faPlusCircle}
                style={{ fontSize: "25px", color: "teal", cursor: "pointer" }}
              />
            </label>
