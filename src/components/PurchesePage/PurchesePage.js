...
const PurchesePage = () => {
  ...
  useEffect(() => {
    fetch("https://time-sheriff-server.vercel.app/products")
      .then((res) => res.json())
  ...
  const handlePurchese = () => {
    ...
    fetch("https://time-sheriff-server.vercel.app/purchese", {
      method: "POST",
      headers: {
      ...
      <div className="container d-flex justify-content-center align-items-center">
        <div>
          <div className="purcheseContainer text-start">
            ...
            <Button onClick={handlePurchese} className="purcheseButton">
              Make a Purchese
            </Button>
          </div>
        </div>
